<?php
	...
	class Header {
		private static $scriptCollection = array(
			...
			'<link href="%root%/CSS/mobiel.css.php" type="text/css" rel="stylesheet" />',
			'<link href="%root%/CSS/cookie.css.php" type="text/css" rel="stylesheet" />',
			'<link href="%root%/CSS/socialMedia.css.php" type="text/css" rel="stylesheet" />',
